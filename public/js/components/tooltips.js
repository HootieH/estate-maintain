const Tooltips = {
  definitions: {
    ...
    'review-queue': {
      title: 'Review Queue',
      text: 'Completed work orders that need a manager to verify the work was done correctly. After a technician marks a job complete, it lands here for quality review before final sign-off. Think of it as the QA step.',
      connections: 'Reviews completed Work Orders before sign-off'
    },
    'approvals': {
      title: 'Approvals',
      text: 'Items that need formal authorization before they can proceed — purchase orders above a threshold, invoices ready for payment, or high-value work orders. This is the financial gate-keeping step.',
      connections: 'Approves Purchase Orders, Invoices, and high-value items'
    },
    'property': {
      title: 'Property',
